...
typedef bool(*fn)(_PhysicsObject*, _PhysicsObject*);

//Function Pointer that will pass into its specific collision function based on shape ID's
static fn CollisionFunctionArray[] = {
	_PhysicsScene::planetoplane, _PhysicsScene::planetocircle, _PhysicsScene::planetosquare,
	_PhysicsScene::circletoplane, _PhysicsScene::circletocircle, _PhysicsScene::circletosquare,
	_PhysicsScene::squaretoplane, _PhysicsScene::squaretocircle, _PhysicsScene::squaretosquare,
};

//Settung variables to Zero
_PhysicsScene::_PhysicsScene() : m_timeStep(0.01f), m_gravity(glm::vec2(0, 0)) { }

_PhysicsScene::~_PhysicsScene()
{
...
void _PhysicsScene::addActor(_PhysicsObject * actor)
{
	//Adds the actor to the back of the Vector
	m_actors.push_back(actor);
}

bool _PhysicsScene::removeActor(_PhysicsObject * actor)
{
...
void _PhysicsScene::update(float deltaTime)
{
...
void _PhysicsScene::checkForCollision()
{
	...
	for (int outer = 0; outer < actorCount - 1; outer++) {
		for (int inner = outer + 1; inner < actorCount; inner++) {
			...
			_PhysicsObject* object1 = m_actors[outer];
			_PhysicsObject* object2 = m_actors[inner];
...
bool _PhysicsScene::planetoplane(_PhysicsObject *, _PhysicsObject *)
{
	//_Planes are static Object and cannot move therefore false
	return false;
}

bool _PhysicsScene::planetocircle(_PhysicsObject* obj1, _PhysicsObject* obj2)
{
	//_Planes are static Object and cannot move therefore false
	return circletoplane(obj2, obj1);
}

bool _PhysicsScene::planetosquare(_PhysicsObject* obj1, _PhysicsObject* obj2)
{
	return squaretoplane(obj2, obj1);
}

bool _PhysicsScene::circletoplane(_PhysicsObject* obj1, _PhysicsObject* obj2)
{
	_Circle* Sphere = dynamic_cast<_Circle*>(obj1);
	_Plane* Line = dynamic_cast<_Plane*>(obj2);
...
bool _PhysicsScene::circletocircle(_PhysicsObject* obj1, _PhysicsObject* obj2)
{
	//Cast the Object to sphere and sphere
	_Circle *Sphere1 = dynamic_cast<_Circle*>(obj1);
	_Circle *Sphere2 = dynamic_cast<_Circle*>(obj2);
...
bool _PhysicsScene::circletosquare(_PhysicsObject* obj1, _PhysicsObject* obj2)
{
	return squaretocircle(obj2, obj1);
}

bool _PhysicsScene::squaretocircle(_PhysicsObject* obj1, _PhysicsObject* obj2)
{
	static vector<float> intersect;

	_AABB *Box1 = dynamic_cast<_AABB*>(obj1);
	_Circle *Sphere1 = dynamic_cast<_Circle*>(obj2);
...
bool _PhysicsScene::squaretoplane(_PhysicsObject* obj1, _PhysicsObject* obj2)
{
	_AABB *Box = dynamic_cast<_AABB*>(obj1);
	_Plane *Line = dynamic_cast<_Plane*>(obj2);
...
bool _PhysicsScene::squaretosquare(_PhysicsObject* obj1, _PhysicsObject* obj2)
{
	_AABB *Box = dynamic_cast<_AABB*>(obj1);
	_AABB *Box2 = dynamic_cast<_AABB*>(obj2);
...
void _PhysicsScene::updateGizmos()
{
	//For all actors
	for (auto pActor : m_actors) {
		//Create a gizmo
...
void _PhysicsScene::setGravity(const glm::vec2& gravity)
{
	this->m_gravity = gravity;
}

glm::vec2 _PhysicsScene::getGravity() const
{
	return m_gravity;
}

void _PhysicsScene::setTimeStep(const float& timeStep)
{
	this->m_timeStep = timeStep;
}

float _PhysicsScene::getTimeStep() const
{
	return m_timeStep;
}
