...
_Plane::_Plane(const glm::vec2& normal, float distance, const glm::vec4& colour) : _PhysicsObject(ShapeType::PLANE) {
...
void _Plane::fixedUpdate(glm::vec2 gravity, float timeStep) {}

void _Plane::debug() {}

void _Plane::makeGizmo()
{
	//Length Of One Line
...
void _Plane::resetPosition() {}

void _Plane::resolveCollision(_RigidBody * actor2)
{
...
glm::vec2 _Plane::getNormal() const
{
	//Returns the Planes Collision Normal
	return m_normal;
}

float _Plane::getDistance() const
{
	//Returns the Planes Distance 
	return m_distance;
}

glm::vec4 _Plane::getColour() const
{
