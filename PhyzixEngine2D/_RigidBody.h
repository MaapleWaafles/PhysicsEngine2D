...
class _RigidBody : public _PhysicsObject {
public:
	_RigidBody();
	//Set Up Constructor
	_RigidBody(ShapeType shapeID, const glm::vec2& position, const glm::vec2& velocity, float linearVelocity, float elasticity, float rotation, float mass);
	~_RigidBody();
	...
	void applyForceToActor(_RigidBody* actor2, glm::vec2 force);
