...
_AABB::_AABB(const glm::vec2& position, const glm::vec2& extents, const glm::vec2& velocity, float linearVelocity, float elasticity, float mass, const glm::vec4& colour) 
	: _RigidBody(SQUARE, position, velocity, linearVelocity, elasticity, 0, mass)
{
